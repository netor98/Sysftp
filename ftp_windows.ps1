...
# Creación de los directorios para el servidor FTP
$nameServer = Read-Host "Ingresa el nombre para tu servidor FTP"
...
# Le quita las propiedades default a los directorios del servidor FTP
...
# Da privilegios de lectura y escritura a los usuarios registrados de cada grupo a la carpeta "General"
...
# Da privilegios de lectura y escritura a los usuarios registrados de cada grupo a su respectiva carpeta de grupo
...
# Habilitar las conexiones mediante SSL [Si es que es requerido]
...
$reprobadosCount = Read-Host "Ingrese la cantidad de usuarios reprobados que desea agregar:"
$recursadoresCount = Read-Host "Ingrese la cantidad de usuarios recursadores que desea agregar:"
...
# Enlazamos la carpeta LocalUser\Public al directorio ServidorFTP\General
cmd /c mklink /d "C:\ServidorFTP\LocalUser\Public\" "C:\ServidorFTP\General"

# Reiniciamos el servidor FTP IIS
Restart-WebItem "IIS:\Sites\$nameServer"

Write-Host "Tu servidor FTP ha sido configurado exitosamente."
Write-Host "CANTIDAD DE USUARIOS REPROBADOS CREADOS: $($reprobados.Nombre -join ', ')"
Write-Host "CANTIDAD DE USUARIOS RECURSADORES CREADOS: $($recursadores.Nombre -join ', ')"